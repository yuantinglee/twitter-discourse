...
\begin{figure*} 
	...
	\end{center}
	\caption{Word shift graph comparing tweets made before and after the release of the report of the coal commission\footnotemark}
...
\begin{figure*} 
	\begin{center}
		\includegraphics[width=0.3\linewidth]{figures/wordshift_coalcomm_report_totalscores}
	\end{center}
	\caption{Total scores of words before and after the release of the coal commission report, sorted by word polarity}
	\label{fig:wordshift_coalcomm_report_totalscores}
\end{figure*}
...
% discuss word shift balances, what is driving
In Fig. \ref{fig:wordshift_coalcomm_report}, the words are labelled by colour according to their individual polarity. In Fig. \ref{fig:wordshift_coalcomm_report_totalscores}, we can see that there is an increase in both negative words as well as positive words. This helps to explain why, looking at the sentiment score on 26 January 2020, there does not appear to be a significant difference in the score compared to the periods immediately before and after. 
...
Fig. \ref{fig:rt_network_bef} and \ref{fig:rt_network_aft} show the two retweet networks of the period before and after the release of the coal commission's report respectively. Within each network, for communities with 500 nodes or more, the top 5 hashtags that are used in the community are also displayed.  
...
Majority of the work done on sentiment analysis is conducted on the English language. In this study, the analysis is done on tweets in German as the policy case study is in Germany. 
